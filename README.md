...
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code\&size=24\&pause=1000\&color=00F7FF\&center=true\&vCenter=true\&width=700\&lines=Computer+%26+Systems+Engineering+Student;Cybersecurity+Focus;Malware+Analysis+%7C+Networking+%7C+AI;Encryption/Decryption+techniques+%7C+Linux)
...
<details>
<summary>🔐 Click to expand Cybersecurity Skills</summary>

<div style="border:1px solid #ddd; border-radius:12px; padding:12px; margin-top:10px;">

🦠 Malware Analysis (Static & Dynamic)  
🌐 Network Security & Threat Detection  
🔐 Encryption & Decryption Techniques  
🖥️ Virtual Machines (VMware)  
🐧 Linux Security & CLI  
...
* Bachelor of Engineering – Capital University (Computer & Systems Engineering) - 2027
* Track: Cybersecurity
...
### ITI – Full Stack Python (2025)

Built full-stack web applications using Python (Flask & Django) with HTML/CSS/JavaScript front-ends and MySQL/PostgreSQL databases.

### NTI – Network Infrastructure (2025)

Cisco Packet Tracer, Routing, VLANs, NAT, ACLs, troubleshooting

### Cisco Networking Academy - Introduction to Cybersecurity (2025)

Cybersecurity fundamentals & threat detection

### Cisco Networking Academy - Computer Hardware Basics(2025)

Knowledge of computer hardware components and architecture.

### University Training (2024)

Web basics, AI intro, data analysis, Arduino
...
![ER Modeling](https://img.shields.io/badge/ER_Modeling-FF6F00?style=for-the-badge&logo=databricks&logoColor=white)
![Relational Design](https://img.shields.io/badge/Relational_Design-4CAF50?style=for-the-badge&logo=apache&logoColor=white)
...
![Microcontrollers](https://img.shields.io/badge/Microcontrollers-FF6F00?style=for-the-badge&logo=microchip&logoColor=white)
...
Teamwork • Communication • Self-learning • Attention to Detail
...
![Visitors](https://komarev.com/ghpvc/?username=eng-mario-atef\&style=for-the-badge)
